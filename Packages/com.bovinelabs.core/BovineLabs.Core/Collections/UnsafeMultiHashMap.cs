...
namespace Unity.Collections {
    ...
    public unsafe struct
        UnsafeMultiHashMap<TKey, TValue> : INativeDisposable,
        ...
        public UnsafeMultiHashMap(int initialCapacity, AllocatorManager.AllocatorHandle allocator) {
            this.data = default;
            this.data.Init(initialCapacity, sizeof(TValue), HashMapHelper<TKey>.kMinCapacity, allocator);
        }
        ...
        public UnsafeHashMapBucketData<TKey, TValue> UnsafeBucketData => new((TValue*)this.data.Ptr, this.data.Keys,
            this.data.Next, this.data.Buckets);
        ...
        public int Remove(TKey key) { return this.data.Remove(key); }
        ...
        /// <param name="key"> The key to look up. </param>
        /// <returns> True if the key was present. </returns>
        public bool ContainsKey(TKey key) { return this.data.Find(key) != -1; }

        /// <summary>
        /// Sets the capacity to match what it would be if it had been originally initialized with all its entries.
        /// </summary>
        public void TrimExcess() { this.data.TrimExcess(); }
    ...
    public static unsafe class UnsafeMultiHashMapExtensions {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReserveAtomicNoResize<TKey, TValue>(this ref UnsafeMultiHashMap<TKey, TValue> hashMap,
            int length)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
    ...
    internal sealed class UnsafeMultiHashMapDebuggerTypeProxy<TKey, TValue>
        ...
        public UnsafeMultiHashMapDebuggerTypeProxy(UnsafeMultiHashMap<TKey, TValue> target) { this.Data = target.data; }
