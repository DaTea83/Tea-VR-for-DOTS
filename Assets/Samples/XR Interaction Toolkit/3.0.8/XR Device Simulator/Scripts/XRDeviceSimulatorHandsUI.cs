...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.DeviceSimulator {
    ...
    class XRDeviceSimulatorHandsUI : MonoBehaviour {
        ...
        class HandExpressionUI {
            ...
            [SerializeField] Text m_BindText;
            ...
            public void SetButtonColor(Color color) { m_ButtonImage.color = color; }
        ...
        [Header("General")] [SerializeField] Image m_HandImage;

        [SerializeField] Sprite m_HandDefaultSprite;

        [SerializeField] List<HandExpressionUI> m_Expressions = new List<HandExpressionUI>();
        ...
        internal void Initialize(XRDeviceSimulator simulator) {
            for (var index = 0; index < simulator.simulatedHandExpressions.Count; ++index) {
                ...
                if (index >= m_Expressions.Count) {
                    ...
                    m_Expressions[index].Initialize(simulatedExpression.toggleAction, simulatedExpression.name,
                        simulatedExpression.icon);
                }
            }
        ...
        internal void ToggleExpression(XRDeviceSimulator.SimulatedHandExpression simulatedExpression,
