...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class NativeParallelHashSetExtensions {
        ...
        public static UnsafeParallelHashMapBucketData GetUnsafeBucketData<TKey>(
            [NoAlias] this NativeParallelHashSet<TKey>.ParallelWriter hashMap)
            where TKey : unmanaged, IEquatable<TKey> {
        ...
        public static void AddBatchUnsafe<T>([NoAlias] this NativeParallelHashSet<T> hashMap,
            [NoAlias] NativeArray<T> keys)
            where T : unmanaged, IEquatable<T> {
