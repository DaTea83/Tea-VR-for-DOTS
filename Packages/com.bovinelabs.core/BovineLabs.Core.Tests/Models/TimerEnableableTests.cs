...
namespace BovineLabs.Core.Tests.Models {
    ...
    public unsafe class TimerEnableableTests {
        ...
        public void CalculatePerformance(int count) {
            ...
            Measure
                .Method(() => { CalculateNew(remainings, isOn, count, 0.6f); })
                .Run();
        ...
        public void CalculatePerformanceOld(int count) {
            ...
            Measure
                .Method(() => { CalculateOld(remainings, isOn, count, 0.6f); })
                .Run();
        ...
        [BurstCompile]
        private static void CalculateOld([NoAlias] float* remainings,
            [NoAlias] ulong* isOn,
            int length,
            float deltaTime) {
            const int perIt = 128;
        ...
        private static void CalculateOld128([NoAlias] float* remainings,
            [NoAlias] ulong* isOn,
            int length,
            float deltaTime) {
        ...
        [BurstCompile]
        private static void CalculateNew([NoAlias] float* remainings,
            [NoAlias] ulong* isOn,
            int length,
            float deltaTime) {
            const int perIt = 128;
        ...
        private static void CalculateNew128([NoAlias] float* remainings,
            [NoAlias] ulong* isOn,
            int length,
            float deltaTime) {
            var u0 = isOn;
        ...
        private static class TimerEnableable {
            public static void CalculateOn([NoAlias] float* remainings,
                [NoAlias] ulong* isOn,
            ...
            private static void CalculateFull([NoAlias] float* remainings,
                [NoAlias] uint* isOn,
                [AssumeRange(0, 32)] int length,
                float deltaTime) {
            ...
            private static void Calculate([NoAlias] float* remainings,
                [NoAlias] uint* isOn,
                [AssumeRange(0, 32)] int length,
                float deltaTime) {
                var length4 = length / 4;
