...
namespace BovineLabs.Core.Collections {
    ...
    public unsafe ref struct BlobBuilderPerfectHashMap<TKey, TValue>
        ...
        public BlobBuilderPerfectHashMap(
            ...
            ref BlobPerfectHashMap<TKey, TValue> data,
        ...
        private static bool HasCollisions(int size,
            NativeHashMap<TKey, TValue> source,
            NativeHashSet<int> usedIndexes) {
            usedIndexes.Clear();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private int IndexFor(TKey key) { return key.GetHashCode() & (this.capacity - 1); }
