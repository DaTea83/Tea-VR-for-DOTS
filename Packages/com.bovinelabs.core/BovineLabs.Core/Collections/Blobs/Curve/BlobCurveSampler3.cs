...
namespace BovineLabs.Core.Collections {
    ...
    public struct BlobCurveSampler3 : IBlobCurveSampler<float3> {
        ...
        public float3 Evaluate(in float time) { return this.Curve.Value.Evaluate(time, ref this.cache); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float3 EvaluateWithoutCache(in float time) { return this.Curve.Value.Evaluate(time); }
