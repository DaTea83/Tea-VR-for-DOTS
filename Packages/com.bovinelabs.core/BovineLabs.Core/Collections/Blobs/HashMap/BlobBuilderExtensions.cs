...
namespace BovineLabs.Core.Collections {
    ...
    public static unsafe class BlobBuilderExtensions {
        ...
        /// </summary>
        public static void Construct<T>(this ref BlobBuilder builder, ref BlobArray<T> dest, in NativeArray<T> src)
            where T : unmanaged {
        ...
        /// Allocates a <see cref="BlobArray{T}"/> inside <paramref name="builder"/> and copies the full contents of <paramref name="src"/> into it.
        /// </summary>
        public static void Construct<T>(this ref BlobBuilder builder, ref BlobArray<T> dest, in NativeList<T> src)
            where T : unmanaged {
            var list = src;
        ...
        public static void ConstructHashMap<TKey, TValue>(
            ...
            ref BlobHashMap<TKey, TValue> blobHashMap,
            ref NativeParallelHashMap<TKey, TValue> source)
        ...
        public static BlobBuilderHashMap<TKey, TValue> AllocateHashMap<TKey, TValue>(
            ...
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
            return AllocateHashMap(ref builder, ref blobHashMap, capacity,
                capacity <= UseBucketCapacityRatioOfThreeUpTo ? 3 : 2);
        }
        ...
        public static BlobBuilderHashMap<TKey, TValue> AllocateHashMap<TKey, TValue>(
            ...
            where TValue : unmanaged {
            var hashmapBuilder =
                new BlobBuilderHashMap<TKey, TValue>(capacity, bucketCapacityRatio, ref builder, ref blobHashMap.Data);
        ...
        public static void ConstructMultiHashMap<TKey, TValue>(
            this ref BlobBuilder builder,
            ref BlobMultiHashMap<TKey, TValue> blobMultiHashMap,
            ref NativeParallelMultiHashMap<TKey, TValue> source)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
            var count = source.Count();
        ...
        public static BlobBuilderMultiHashMap<TKey, TValue> AllocateMultiHashMap<TKey, TValue>(
            ...
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
            return new BlobBuilderMultiHashMap<TKey, TValue>(capacity,
                capacity <= UseBucketCapacityRatioOfThreeUpTo ? 3 : 2, ref builder,
        ...
        public static BlobBuilderMultiHashMap<TKey, TValue> AllocateMultiHashMap<TKey, TValue>(
            ...
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
            return new BlobBuilderMultiHashMap<TKey, TValue>(capacity, bucketCapacityRatio, ref builder,
                ref blobMultiHashMap.Data);
        }
        ...
        public static BlobBuilderPerfectHashMap<TKey, TValue> ConstructPerfectHashMap<TKey, TValue>(
            this ref BlobBuilder builder,
            ref BlobPerfectHashMap<TKey, TValue> blobHashMap,
            NativeHashMap<TKey, TValue> source,
        ...
        private struct BlobBuilderInternal {
            ...
            public void AllocateBlobAssetReference(ref BlobBuilder target, ref BlobPtr<BlobAssetHeader> blobPtr) {
                ...
                var sortedAllocs =
                    new NativeArray<SortedIndex>(this.Allocations.Length, Unity.Collections.Allocator.Temp);
            ...
            private struct SortedIndex : IComparable<SortedIndex> {
                ...
                public int CompareTo(SortedIndex other) { return ((ulong)this.P).CompareTo((ulong)other.P); }
            }
        }
    }
}