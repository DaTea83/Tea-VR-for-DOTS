...
#pragma warning restore SA1649
    ...
    public struct Equals<T> : IPredicate<T>
        ...
        public Equals(T value) { this.value = value; }

        public bool Check(T other) { return this.value.Equals(other); }
    }
    ...
    public static unsafe class NativeArrayExtensions {
        ...
        public static NativeArray<T> Where<T, TPredicate>(this NativeArray<T> array,
