...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class EntityDataAccessExtensions {
        ...
        internal static byte* GetComponentDataWithTypeRW(
            ...
            uint globalVersion,
            ref LookupCache cache) {
            var data = ChunkDataUtility.GetComponentDataWithTypeRW(chunk, archetype, indexInChunk, typeIndex,
...
#endif
        {
            ...
            return new UntypedDynamicBuffer(header, safety, arrayInvalidationSafety, isReadOnly, useMemoryInit,
        ...
        private static void JournalAddRecord(EntityComponentStore* store,
            Entity entity,
            TypeIndex typeIndex,
            uint version,
            void* data) {
            ...
            EntitiesJournaling.AddRecord(recordType, store, version, &entity, 1, types: &typeIndex, typeCount: 1,
                data: recordData,
        ...
        internal static void SetComponentEnabled(
            ...
            EntitiesJournaling.AddRecord(
                ...
                access.m_WorldUnmanaged.SequenceNumber, access.m_WorldUnmanaged.ExecutingSystem,
                originSystem: in originSystem, entities: entities,
