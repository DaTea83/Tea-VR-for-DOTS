...
namespace Unity.Collections {
    ...
    public unsafe struct
        NativeMultiHashMap<TKey, TValue> : INativeDisposable,
        IEnumerable<KVPair<TKey, TValue>> // Used by collection initializers.
        where TKey : unmanaged, IEquatable<TKey>
        where TValue : unmanaged {
        [NativeDisableUnsafePtrRestriction] internal HashMapHelper<TKey>* data;

#if ENABLE_UNITY_COLLECTIONS_CHECKS
        internal AtomicSafetyHandle m_Safety;
        private static readonly SharedStatic<int> s_staticSafetyId =
            SharedStatic<int>.GetOrCreate<NativeMultiHashMap<TKey, TValue>>();
#endif
        ...
        public NativeMultiHashMap(int initialCapacity, AllocatorManager.AllocatorHandle allocator) {
            this.data = HashMapHelper<TKey>.Alloc(initialCapacity, sizeof(TValue), HashMapHelper<TKey>.kMinCapacity,
                allocator);
            ...
            CollectionHelper.SetStaticSafetyId<NativeMultiHashMap<TKey, TValue>>(ref this.m_Safety,
...
#else
            var jobHandle =
                new NativeHashMapDisposeJob { Data = new NativeHashMapDispose { m_HashMapData =
 (UnsafeHashMap<int, int>*)this.data } }.Schedule(inputDeps);
#endif
            this.data = null;
        ...
        public readonly NativeKeyValueArrays<TKey, TValue>
            GetKeyValueArrays(AllocatorManager.AllocatorHandle allocator) {
            this.CheckRead();
        ...
        public ReadOnly AsReadOnly() { return new ReadOnly(ref this); }
        ...
        public readonly struct ReadOnly : IEnumerable<KVPair<TKey, TValue>> {
            [NativeDisableUnsafePtrRestriction] private readonly HashMapHelper<TKey>* data;
    ...
    public static unsafe class NativeMultiHashMapExtensions {
        ...
        public static bool RemoveFirst<TKey, TValue>(this NativeMultiHashMap<TKey, TValue> hashMap,
            TKey key,
            TValue value)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged, IEquatable<TValue> {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ReserveAtomicNoResize<TKey, TValue>(this ref NativeMultiHashMap<TKey, TValue> hashMap,
            int length)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        public static void GetUniqueKeyArray<TKey, TValue>(this NativeMultiHashMap<TKey, TValue> container,
    ...
    internal static unsafe class HashMapHelperExtensions {
        ...
        internal static int Remove<TKey, TValue>(this ref HashMapHelper<TKey> hashMapHelper,
            in TKey key,
            in TValue value)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged, IEquatable<TValue> {
        ...
        internal static bool RemoveFirst<TKey, TValue>(this ref HashMapHelper<TKey> hashMapHelper,
            in TKey key,
            in TValue value)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged, IEquatable<TValue> {
        ...
        internal static bool TryGetFirstValue<TKey, TValue>(this in HashMapHelper<TKey> hashMapHelper,
            TKey key,
            out TValue item,
            out HashMapIterator<TKey> it)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
            it.Key = key;
        ...
        internal static bool TryGetNextValue<TKey, TValue>(this in HashMapHelper<TKey> hashMapHelper,
            out TValue item,
            ref HashMapIterator<TKey> it)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        internal static void GetKeyArray<TKey>(this in HashMapHelper<TKey> hashMapHelper, NativeList<TKey> result)
            ...
            for (int i = 0, count = 0, max = result.Length, capacity = hashMapHelper.BucketCapacity;
    ...
    internal sealed unsafe class NativeMultiHashMapDebuggerTypeProxy<TKey, TValue>
        ...
        public NativeMultiHashMapDebuggerTypeProxy(NativeMultiHashMap<TKey, TValue> target) { this.data = target.data; }
