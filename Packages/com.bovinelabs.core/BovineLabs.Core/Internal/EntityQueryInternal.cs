...
namespace BovineLabs.Core.Internal {
    ...
    public static unsafe class EntityQueryInternal {
        public static SharedComponentData GetSharedFilters(this EntityQuery query) {
            return UnsafeUtility.As<EntityQueryFilter.SharedComponentData, SharedComponentData>(
                ref query._GetImpl()->_Filter.Shared);
        }
        ...
        public static ref SharedComponentData GetSharedFiltersAsRef(this EntityQuery query) {
            ...
            return ref UnsafeUtility.As<EntityQueryFilter.SharedComponentData, SharedComponentData>(
                ref entityQueryImpl._Filter.Shared);
        }
    }
}