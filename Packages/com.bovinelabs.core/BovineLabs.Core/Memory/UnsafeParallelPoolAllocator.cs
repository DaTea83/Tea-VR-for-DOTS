...
namespace BovineLabs.Core.Memory {
    ...
    public unsafe struct UnsafeParallelPoolAllocator<T> : IDisposable
        ...
        [NativeDisableUnsafePtrRestriction] private UnsafePoolAllocator<T>* pools;
        ...
        public T* Alloc() { return this.pools[this.threadIndex].Alloc(); }

        public void Free(T* p) { this.pools[this.threadIndex].Free(p); }
