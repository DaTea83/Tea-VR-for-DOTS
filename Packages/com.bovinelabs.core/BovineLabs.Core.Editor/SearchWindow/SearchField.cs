...
namespace BovineLabs.Core.Editor.SearchWindow {
    ...
    internal partial class SearchField : TextField {
        ...
        public SearchField() { this.LoadLayout(); }
        ...
        private void LoadLayout() {
            ...
            this.RegisterCallback<FocusInEvent, SearchField>(
                (_, sc) => sc.searchContainer.style.display = DisplayStyle.None, this);
            this.RegisterCallback<FocusOutEvent, SearchField>(
                (_, sc) => sc.searchContainer.style.display =
                    sc.value.Length == 0 ? DisplayStyle.Flex : DisplayStyle.None, this);
        }
    }
}