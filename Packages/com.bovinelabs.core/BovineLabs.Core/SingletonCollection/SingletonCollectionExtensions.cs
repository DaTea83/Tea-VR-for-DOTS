...
namespace BovineLabs.Core.SingletonCollection {
    ...
    public static class SingletonCollectionExtensions {
        ...
        public static unsafe NativeHashMap<TKey, TValue> CreateHashMap<TS, TKey, TValue>(this TS eventSingleton,
            int capacity)
        ...
        public static unsafe NativeMultiHashMap<TKey, TValue> CreateMultiHashMap<TS, TKey, TValue>(
            this TS eventSingleton,
            int capacity)
        ...
        public static unsafe NativeParallelHashMap<TKey, TValue> CreateParallelHashMap<TS, TKey, TValue>(
            this TS eventSingleton,
            int capacity)
        ...
        public static unsafe NativeParallelMultiHashMap<TKey, TValue> CreateParallelMultiHashMap<TS, TKey, TValue>(
            this TS eventSingleton,
            int capacity)
