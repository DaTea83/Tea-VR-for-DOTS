...
namespace BovineLabs.Core.Utility {
    ...
    public static class TransformUtility {
        public static void SetupParent<T>(
            ...
            commands.AddComponent(new ComponentTypeSet(ComponentType.ReadWrite<Parent>(),
            ...
            commands.SetComponent(new LocalToWorld
                { Value = math.mul(parentLocalToWorld.Value, childLocalTransform.ToMatrix()) });
