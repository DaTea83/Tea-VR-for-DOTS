...
namespace BovineLabs.Core.Collections {
    ...
    public readonly unsafe struct UnmanagedPool<T> : IDisposable
        ...
        [NativeDisableUnsafePtrRestriction] private readonly int* length;

        [NativeDisableUnsafePtrRestriction] private readonly SpinLock* spinner;
        ...
        public UnmanagedPool(int capacity, Allocator allocator = Allocator.Persistent) {
            ...
            this.buffer =
                (T*)UnsafeUtility.MallocTracked(sizeof(T) * capacity, UnsafeUtility.AlignOf<T>(), allocator, 0);
