...
namespace BovineLabs.Core.Spatial {
    ...
    public struct SpatialMap<T> : IDisposable
        ...
        public unsafe struct QuantizeJob : IJobFor {
            ...
            [NativeDisableParallelForRestriction] public NativeParallelMultiHashMap<int, int> Map;
    ...
    public static class SpatialMap {
        ...
        public readonly struct ReadOnly {
            ...
            [field: ReadOnly] public NativeParallelMultiHashMap<int, int> Map { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public int Hash(int2 quantized) { return SpatialMap.Hash(quantized, this.quantizeWidth); }
        }
