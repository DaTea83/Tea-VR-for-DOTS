...
namespace BovineLabs.Core.Extensions {
    ...
    public readonly unsafe struct EntityCache {
        ...
        internal byte* GetOptionalComponentDataWithTypeRO(TypeIndex typeIndex, ref LookupCache cache) {
            return ChunkDataUtility.GetOptionalComponentDataWithTypeRO(this.EntityInChunk.Chunk, this.Archetype,
                this.EntityInChunk.IndexInChunk, typeIndex,
                ref cache);
        }

        internal byte* GetOptionalComponentDataWithTypeRW(TypeIndex typeIndex,
            uint globalVersion,
            ref LookupCache cache) {
            var data = ChunkDataUtility.GetOptionalComponentDataWithTypeRW(this.EntityInChunk.Chunk, this.Archetype,
                this.EntityInChunk.IndexInChunk, typeIndex,
...
// #endif
        ...
        internal byte* GetComponentDataWithTypeRO(TypeIndex typeIndex, ref LookupCache cache) {
            return ChunkDataUtility.GetComponentDataWithTypeRO(this.EntityInChunk.Chunk, this.Archetype,
                this.EntityInChunk.IndexInChunk, typeIndex, ref cache);
        }

        internal byte* GetComponentDataWithTypeRW(TypeIndex typeIndex, uint globalVersion, ref LookupCache cache) {
            var data = ChunkDataUtility.GetComponentDataWithTypeRW(this.EntityInChunk.Chunk, this.Archetype,
                this.EntityInChunk.IndexInChunk, typeIndex,
                globalVersion, ref cache);
