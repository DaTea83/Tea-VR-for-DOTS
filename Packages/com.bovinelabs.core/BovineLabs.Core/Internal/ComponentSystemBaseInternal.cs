...
namespace BovineLabs.Core.Internal {
    ...
    public static class ComponentSystemBaseInternal {
        public static EntityQuery
            GetEntityQuery(this ComponentSystemBase system, params ComponentType[] componentTypes) {
        ...
        public static unsafe void RequireSingletonForUpdate(this ComponentSystemBase system,
