...
namespace BovineLabs.Core.Collections {
    ...
    public unsafe struct BlobHashMapEnumerator<TKey, TValue> : IEnumerator<KVPair<TKey, TValue>>
        ...
        [NativeDisableUnsafePtrRestriction] private readonly BlobHashMapData<TKey, TValue>* data;
        private int index;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool MoveNext() { return MoveNext(this.data, ref this.bucketIndex, ref this.nextIndex, out this.index); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool MoveNext(BlobHashMapData<TKey, TValue>* data,
            ref int bucketIndex,
            ref int nextIndex,
            out int index) {
            if (nextIndex != -1) {
        ...
        private static bool MoveNextSearch(BlobHashMapData<TKey, TValue>* data,
            ref int bucketIndex,
            out int nextIndex,
            out int index) {
