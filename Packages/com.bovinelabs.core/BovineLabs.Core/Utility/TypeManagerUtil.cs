...
namespace BovineLabs.Core.Utility {
    ...
    public static unsafe class TypeManagerUtil {
        ...
        public static NativeArray<ComponentType> GetWriteGroupComponents(ComponentType componentType,
            Allocator allocator) {
        ...
        public static void GetWriteGroupComponents<T>(
            Allocator allocator,
            out NativeArray<ComponentType> enableComponents,
            out NativeArray<ComponentType> normalComponents) {
        ...
        public static void GetWriteGroupComponents(
            ...
            normalComponents =
                new NativeArray<ComponentType>(typeInfo.WriteGroupCount - enableComponentCount, allocator);
