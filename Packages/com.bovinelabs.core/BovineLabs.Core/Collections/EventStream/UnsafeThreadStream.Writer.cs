...
namespace BovineLabs.Core.Collections {
    ...
    public unsafe partial struct UnsafeThreadStream {
        ...
        public readonly struct Writer {
            [NativeDisableUnsafePtrRestriction] private readonly UnsafeThreadStreamBlockData* blockStream;

            internal Writer(ref UnsafeThreadStream stream) { this.blockStream = stream.blockData; }
