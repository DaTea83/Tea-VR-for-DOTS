...
namespace BovineLabs.Core.Editor.Internal {
    ...
    public static class SearchBridge {
        public static IQueryEngineFilter SetFilter<TFilter, TData>(QueryEngine<TData> queryEngine,
            string? token,
        ...
        public static IQueryEngineFilter AddOrUpdateProposition(this IQueryEngineFilter filter,
            string label,
