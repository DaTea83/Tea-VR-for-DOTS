...
namespace TeaFramework {
    ...
    public class FollowParentAuthoring : MonoBehaviour {
        ...
        private void OnValidate() { followTarget = transform.parent.gameObject; }
    ...
    public class FollowParentEditor : Editor {
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.HelpBox(
                "When you add rigidbody to an entity, usually it will automatically remove the parent component",
                MessageType.Info);
            EditorGUILayout.HelpBox("This component is to add back if you still want the parent component",
                MessageType.Info);

            authoring.followTarget =
                (GameObject)EditorGUILayout.ObjectField("Follow Target", authoring.followTarget, typeof(GameObject),
                    true);
        }
    }
