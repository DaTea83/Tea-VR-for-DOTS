...
namespace BovineLabs.Core.Internal {
    ...
    public static class Bitwise {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int FromBool(bool value) { return Unity.Collections.Bitwise.FromBool(value); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int lzcnt(byte value) { return Unity.Collections.Bitwise.lzcnt(value); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int tzcnt(byte value) { return Unity.Collections.Bitwise.tzcnt(value); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int lzcnt(ushort value) { return Unity.Collections.Bitwise.lzcnt(value); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int tzcnt(ushort value) { return Unity.Collections.Bitwise.tzcnt(value); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe bool IsSet(ulong* ptr, int pos) { return Unity.Collections.Bitwise.IsSet(ptr, pos); }
