...
namespace BovineLabs.Core.Collections {
    ...
    public unsafe struct UnsafePartialKeyedMap<TValue> : INativeDisposable
        ...
        [NativeDisableUnsafePtrRestriction] private int* keys;

        private int count;
        private int nextCapacity;
        private int bucketCapacity;

        public UnsafePartialKeyedMap(int* keys,
            TValue* values,
            int length,
            int bucketCapacity,
            ...
            this.Buckets =
                (int*)Memory.Unmanaged.Allocate(sizeof(int) * bucketCapacity, JobsUtility.CacheLineSize, allocator);
        ...
        public void Update(int* newKeys, TValue* newValues, int newLength) {
            ...
            if (this.nextCapacity < newLength) {
                ...
                this.Next = (int*)Memory.Unmanaged.Allocate(sizeof(int) * this.nextCapacity, JobsUtility.CacheLineSize,
                    this.Allocator);
            }
