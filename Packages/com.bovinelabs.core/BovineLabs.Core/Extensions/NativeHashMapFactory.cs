...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class NativeHashMapFactory<TKey, TValue>
        ...
        private static readonly SharedStatic<int> StaticSafetyId =
            SharedStatic<int>.GetOrCreate<NativeHashMap<TKey, TValue>>();
#endif

        public static NativeHashMap<TKey, TValue> Create(int initialCapacity,
            int minGrowth,
            ...
            CollectionHelper.SetStaticSafetyId<NativeHashMap<TKey, TValue>>(ref hashMap.m_Safety,
                ref StaticSafetyId.Data);
