...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class NativeHashSetFactory<T>
        ...
        public static NativeHashSet<T> Create(int initialCapacity,
            int minGrowth,
            ...
            CollectionHelper.SetStaticSafetyId<NativeHashSet<T>>(ref hashSet.m_Safety,
                ref NativeHashSet<T>.s_staticSafetyId.Data);
