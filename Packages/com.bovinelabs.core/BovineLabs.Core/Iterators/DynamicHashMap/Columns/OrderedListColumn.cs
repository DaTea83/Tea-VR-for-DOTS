...
namespace BovineLabs.Core.Iterators.Columns {
    ...
    public unsafe struct OrderedListColumn<T> : IColumn<T>
        ...
        /// </remarks>
        public T GetValue(int idx) { return UnsafeUtility.ReadArrayElement<T>(this.Keys, idx); }
        ...
        public int GetFirst() { return this.head; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int GetNext(int current) { return this.Next[current]; }
        ...
        private readonly struct Resize {
            ...
            public Resize(ref OrderedListColumn<T> column) {
                ...
                this.oldNext = (int*)UnsafeUtility.Malloc(this.oldCapacity * sizeof(int), UnsafeUtility.AlignOf<int>(),
                    Allocator.Temp);
                this.oldPrev = (int*)UnsafeUtility.Malloc(this.oldCapacity * sizeof(int), UnsafeUtility.AlignOf<int>(),
                    Allocator.Temp);
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public T GetValue(int idx) { return this.oldKeys[idx]; }
