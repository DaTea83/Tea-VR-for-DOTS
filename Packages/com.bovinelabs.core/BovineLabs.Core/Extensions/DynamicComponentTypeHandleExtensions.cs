...
namespace BovineLabs.Core.Extensions {
    ...
    public static class DynamicComponentTypeHandleExtensions {
        public static DynamicComponentTypeHandle Clone(this DynamicComponentTypeHandle handle,
            ComponentType componentType) {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            return new DynamicComponentTypeHandle(componentType, handle.m_Safety0, handle.m_Safety1,
