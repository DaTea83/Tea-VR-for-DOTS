...
namespace BovineLabs.Core.Extensions {
    ...
    public static class SystemStateExtensions {
        ...
        public static JobHandle GetInternalDependency(ref this SystemState system) { return system.m_JobHandle; }

        public static SharedComponentDataFromIndex<T> GetSharedComponentDataFromIndex<T>(ref this SystemState system,
        ...
        public static SharedComponentLookup<T> GetSharedComponentLookup<T>(ref this SystemState system,
            bool isReadOnly = false)
        ...
        public static UnsafeComponentLookup<T> GetUnsafeComponentLookup<T>(ref this SystemState system,
            bool isReadOnly = false)
        ...
        public static UnsafeBufferLookup<T> GetUnsafeBufferLookup<T>(ref this SystemState system,
            bool isReadOnly = false)
        ...
        public static ChangeFilterLookup<T> GetChangeFilterLookup<T>(ref this SystemState system,
            bool isReadOnly = false)
            where T : unmanaged {
            system.AddReaderWriter(isReadOnly ? ComponentType.ReadOnly<T>() : ComponentType.ReadWrite<T>());
        ...
        public static void SetSingleton<T>(ref this SystemState state, T value, bool completeDependency = true)
            where T : unmanaged, IComponentData {
            var query = new EntityQueryBuilder(Allocator.Temp).WithAllRW<T>().WithOptions(QueryOptions)
                .Build(ref state);
            if (completeDependency) {
                query.CompleteDependency();
            }
        ...
        public static bool TryGetSingleton<T>(ref this SystemState state,
            out T component,
        ...
        public static bool TryGetManagedSingleton<T>(ref this SystemState state,
            out T component,
            bool completeDependency = true)
            where T : class, IComponentData {
            var query = new EntityQueryBuilder(Allocator.Temp).WithAllRW<T>().WithOptions(QueryOptions)
