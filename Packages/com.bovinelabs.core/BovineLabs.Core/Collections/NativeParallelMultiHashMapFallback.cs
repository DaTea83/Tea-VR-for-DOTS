...
namespace BovineLabs.Core.Collections {
    ...
    public unsafe struct NativeParallelMultiHashMapFallback<TKey, TValue> : IDisposable
        ...
        public void Clear() { this.HashMap.Clear(); }

        public JobHandle Apply(JobHandle jobHandle,
            out NativeParallelMultiHashMap<TKey, TValue>.ReadOnly reader,
            ApplyJob job = default) {
        ...
        public JobHandle Dispose(JobHandle jobHandle) { return this.Fallback.Dispose(jobHandle); }
        ...
        public readonly struct ParallelWriter {
            ...
            internal ParallelWriter(NativeParallelMultiHashMap<TKey, TValue>.ParallelWriter hashMap,
                NativeQueue<FallbackData>.ParallelWriter fallback) {
...
#endif
                this.AddBatch((TKey*)keys.GetUnsafeReadOnlyPtr(), (TValue*)values.GetUnsafeReadOnlyPtr(),
                    (int*)hashes.GetUnsafeReadOnlyPtr(), keys.Length);
            }
