...
namespace BovineLabs.Core.Iterators {
    ...
    public readonly struct CustomChunkIterator<T>
        ...
        public CustomChunkIterator(T execute) { this.execute = execute; }
        ...
        public void Execute(in ArchetypeChunk chunk, bool useEnabledMask, in v128 chunkEnabledMask) {
            ...
            if (!useEnabledMask) {
                ...
                if (useRanges) {
                    var chunkEndIndex = 0;
                    while (EnabledBitUtility.TryGetNextRange(chunkEnabledMask, chunkEndIndex,
                               out var entityIndexInChunk, out chunkEndIndex)) {
