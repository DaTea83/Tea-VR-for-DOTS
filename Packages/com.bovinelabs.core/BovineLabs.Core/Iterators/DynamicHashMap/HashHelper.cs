...
namespace BovineLabs.Core.Iterators {
    ...
    internal unsafe struct HashHelper<TKey>
        ...
        public HashHelper(byte* parentPtr,
            HashHelper<TKey>* thisPtr,
            int hashMapDataSize,
            int keyOffset,
            int nextOffset,
            int bucketsOffset) {
        ...
        public readonly struct Resize {
            ...
            public Resize(ref HashHelper<TKey> helper, int oldCapacity, int oldBucketCapacity) {
                ...
                this.OldKeys = (TKey*)UnsafeUtility.Malloc(oldCapacity * sizeof(TKey), UnsafeUtility.AlignOf<TKey>(),
                    Allocator.Temp);
                this.OldNext = (int*)UnsafeUtility.Malloc(oldCapacity * sizeof(int), UnsafeUtility.AlignOf<int>(),
                    Allocator.Temp);
                this.OldBuckets = (int*)UnsafeUtility.Malloc(oldBucketCapacity * sizeof(int),
