...
namespace BovineLabs.Core.Editor.Windows.Base {
    ...
    public abstract class BaseDisplayPreferences : IEditorPreference {
        [SerializeField] [Range(20, 40)] [Tooltip("Height of each item in pixels")]
        private int itemHeight = 27;

        [SerializeField] [Tooltip("Whether to use a monospace font for the list")]
        private bool useMonospaceFont;

        [SerializeField] [Tooltip("Whether to show icons/thumbnails for objects")]
        private bool showIcons = true;

        [SerializeField] [Tooltip("Whether to show timestamps")]
        private bool showTimestamps;

        [SerializeField] [Tooltip("Whether to show asset paths for assets")]
        private bool showAssetPaths;

        [SerializeField] [Tooltip("Whether to show type names (e.g. GameObject) in the list")]
        private bool showTypeNames = true;

        [SerializeField] [Tooltip("Whether to show the status bar at the bottom of the window")]
        private bool showStatusBar;

        [SerializeField] [Tooltip("Whether to grey out objects that no longer exist or are missing")]
        private bool greyOutUnloadedObjects;

        [SerializeField] [Tooltip("Whether to highlight currently selected objects in the list")]
        private bool highlightCurrentSelection = true;

        [SerializeField] [Range(0.1f, 1.0f)] [Tooltip("Time threshold for double-click detection in seconds")]
        ...
        /// </summary>
        public int ItemHeight { get => Math.Clamp(this.itemHeight, 16, 64); set => this.itemHeight = value; }

        /// <summary>
        /// Gets or sets a value indicating whether to use a monospace font for the list.
        /// </summary>
        public bool UseMonospaceFont { get => this.useMonospaceFont; set => this.useMonospaceFont = value; }

        /// <summary>
        /// Gets or sets a value indicating whether to show icons.
        /// </summary>
        public bool ShowIcons { get => this.showIcons; set => this.showIcons = value; }

        /// <summary>
        /// Gets or sets a value indicating whether to show timestamps.
        /// </summary>
        public bool ShowTimestamps { get => this.showTimestamps; set => this.showTimestamps = value; }

        /// <summary>
        /// Gets or sets a value indicating whether to show asset paths.
        /// </summary>
        public bool ShowAssetPaths { get => this.showAssetPaths; set => this.showAssetPaths = value; }

        /// <summary>
        /// Gets or sets a value indicating whether to show type names in the list.
        /// </summary>
        public bool ShowTypeNames { get => this.showTypeNames; set => this.showTypeNames = value; }

        /// <summary>
        /// Gets or sets a value indicating whether to show the status bar.
        /// </summary>
        public bool ShowStatusBar { get => this.showStatusBar; set => this.showStatusBar = value; }
