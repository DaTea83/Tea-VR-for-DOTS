...
namespace UnityEngine.XR.Hands.Samples.Gestures.DebugTools {
    ...
    public class XRSelectedHandShapeDebugUI : MonoBehaviour {
        ...
        [SerializeField] [Tooltip("The label that will be used to display the name of the hand shape.")]
        TextMeshProUGUI m_HandShapeNameLabel;

        /// <summary>
        /// The text label that denotes and displays the currently detected hand gesture
        /// </summary>
        public TextMeshProUGUI handShapeNameLabel { get => m_HandShapeNameLabel; set => m_HandShapeNameLabel = value; }

        void Awake() { m_HandShapeNameLabel.text = k_NoGestureDetectedString; }
        ...
        /// </summary>
        public void ResetUI() { m_HandShapeNameLabel.text = k_NoGestureDetectedString; }
    }
}