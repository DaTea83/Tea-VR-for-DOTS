...
namespace BovineLabs.Core.Internal {
    ...
    public static class RuntimeContentCatalogUtility {
        public static void GetSubScenesAndArchives(string catalogPath,
            out List<Hash128> scenes,
            out List<Hash128> archives) {
        ...
        public static List<Hash128> GetSubScenes(string catalogPath) {
            ...
            if (!string.IsNullOrEmpty(catalogPath) && BlobAssetReference<RuntimeContentCatalogData>.TryRead(catalogPath,
                    1, out BlobAssetReference<RuntimeContentCatalogData> catalogData)) {
                GetSubScenes(catalogData, scenes);
                catalogData.Dispose();
            }
        ...
        private static void GetSubScenes(BlobAssetReference<RuntimeContentCatalogData> catalogData,
            List<Hash128> scenes) {
        ...
        private static void GetArchives(BlobAssetReference<RuntimeContentCatalogData> catalogData,
            List<Hash128> archives) {
