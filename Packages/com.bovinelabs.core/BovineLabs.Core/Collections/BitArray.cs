...
namespace BovineLabs.Core.Collections {
    ...
    public struct BitArray8 : IBitArray<BitArray8> {
        ...
        public byte Data { readonly get => this.data; set => this.data = value; }
        ...
        /// <inheritdoc />
        public bool this[int index] { readonly get => this[(uint)index]; set => this[(uint)index] = value; }

        /// <summary> Bit-wise Not operator. </summary>
        /// <param name="a"> Bit array with which to do the operation. </param>
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray8 operator ~(BitArray8 a) { return new BitArray8((byte)~a.data); }
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray8 operator |(BitArray8 a, BitArray8 b) { return new BitArray8((byte)(a.data | b.data)); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(BitArray8 a, BitArray8 b) { return a.data == b.data; }
        ...
        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray8 BitAnd(BitArray8 other) { return this & other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray8 BitOr(BitArray8 other) { return this | other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray8 BitNot() { return ~this; }

        /// <inheritdoc />
        public readonly int CountBits() { return math.countbits((uint)this.data); }
        ...
        public readonly override bool Equals(object obj) { return obj is BitArray8 array8 && array8.data == this.data; }

        /// <summary>
        /// Get the hashcode of the bit array.
        /// </summary>
        /// <returns> Hashcode of the bit array. </returns>
        public readonly override int GetHashCode() { return 1768953197 + this.data.GetHashCode(); }

        public readonly bool Equals(BitArray8 other) { return this.data == other.data; }
    }
    ...
    public struct BitArray16 : IBitArray<BitArray16> {
        ...
        public ushort Data { readonly get => this.data; set => this.data = value; }
        ...
        /// <inheritdoc />
        public readonly string HumanizedData => Regex
            .Replace($"{Convert.ToString(this.data, 2),16}".Replace(' ', '0'), ".{8}", "$0.").TrimEnd('.');
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray16 operator ~(BitArray16 a) { return new BitArray16((ushort)~a.data); }
        ...
        /// <returns> True if both bit arrays are equals. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(BitArray16 a, BitArray16 b) { return a.data == b.data; }
        ...
        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray16 BitAnd(BitArray16 other) { return this & other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray16 BitOr(BitArray16 other) { return this | other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray16 BitNot() { return ~this; }
        ...
        public readonly bool Equals(BitArray16 other) { return this.data == other.data; }
    }
    ...
    public struct BitArray32 : IBitArray<BitArray32> {
        ...
        public BitArray32(uint rawValue) { this.data = rawValue; }
        ...
        public uint Data { readonly get => this.data; set => this.data = value; }
        ...
        /// <inheritdoc />
        public readonly string HumanizedData => Regex
            .Replace($"{Convert.ToString(this.data, 2),32}".Replace(' ', '0'), ".{8}", "$0.").TrimEnd('.');
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray32 operator ~(BitArray32 a) { return new BitArray32(~a.data); }
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray32 operator |(BitArray32 a, BitArray32 b) { return new BitArray32(a.data | b.data); }
        ...
        /// <returns> True if both bit arrays are equals. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(BitArray32 a, BitArray32 b) { return a.data == b.data; }
        ...
        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray32 BitAnd(BitArray32 other) { return this & other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray32 BitOr(BitArray32 other) { return this | other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray32 BitNot() { return ~this; }

        /// <inheritdoc />
        public readonly int CountBits() { return math.countbits(this.data); }
        ...
        public readonly bool Equals(BitArray32 other) { return this.data == other.data; }
    }
    ...
    public struct BitArray64 : IBitArray<BitArray64> {
        ...
        public ulong Data { readonly get => this.data; set => this.data = value; }
        ...
        /// <inheritdoc />
        public readonly string HumanizedData => Regex
            .Replace($"{Convert.ToString((long)this.data, 2),64}".Replace(' ', '0'), ".{8}", "$0.").TrimEnd('.');
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray64 operator ~(BitArray64 a) { return new BitArray64(~a.data); }
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray64 operator |(BitArray64 a, BitArray64 b) { return new BitArray64(a.data | b.data); }
        ...
        /// <returns> True if both bit arrays are equals. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(BitArray64 a, BitArray64 b) { return a.data == b.data; }
        ...
        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray64 BitAnd(BitArray64 other) { return this & other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray64 BitOr(BitArray64 other) { return this | other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray64 BitNot() { return ~this; }
        ...
        public readonly bool Equals(BitArray64 other) { return this.data == other.data; }
    }
    ...
    public struct BitArray128 : IBitArray<BitArray128> {
        ...
        /// <returns> The resulting bit array. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static BitArray128 operator ~(BitArray128 a) { return new BitArray128(~a.data1, ~a.data2); }
        ...
        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray128 BitAnd(BitArray128 other) { return this & other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray128 BitOr(BitArray128 other) { return this | other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray128 BitNot() { return ~this; }

        /// <inheritdoc />
        public readonly int CountBits() { return math.countbits(this.data1) + math.countbits(this.data2); }
        ...
        /// <returns> True if the provided bit array is equal to this.. </returns>
        public readonly override bool Equals(object obj) {
            return obj is BitArray128 array128 && this.data1.Equals(array128.data1) &&
                   this.data2.Equals(array128.data2);
        }
    ...
    public struct BitArray256 : IBitArray<BitArray256> {
        ...
        [SerializeField] [DontCreateProperty] private ulong data1;

        [SerializeField] [DontCreateProperty] private ulong data2;

        [SerializeField] [DontCreateProperty] private ulong data3;

        [SerializeField] [DontCreateProperty] private ulong data4;
        ...
        [CreateProperty] public readonly ulong Data1 => this.data1;

        [CreateProperty] public readonly ulong Data2 => this.data2;

        [CreateProperty] public readonly ulong Data3 => this.data3;

        [CreateProperty] public readonly ulong Data4 => this.data4;

        /// <inheritdoc />
        public readonly uint Capacity => 256u;

        /// <inheritdoc />
        public readonly bool AllFalse =>
            this.data1 == 0uL && this.data2 == 0uL && this.data3 == 0uL && this.data4 == 0uL;

        /// <inheritdoc />
        public readonly bool AllTrue =>
            this.data1 == ulong.MaxValue && this.data2 == ulong.MaxValue && this.data3 == ulong.MaxValue &&
        ...
        public bool this[uint index] {
            ...
            set => BitArrayUtilities.Set256(index, ref this.data1, ref this.data2, ref this.data3, ref this.data4,
                value);
        }
        ...
        public readonly bool IsPowerOf2() {
            ...
            return math.countbits(this.data1) + math.countbits(this.data2) + math.countbits(this.data3) +
                math.countbits(this.data4) == 1;
        }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray256 BitAnd(BitArray256 other) { return this & other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray256 BitOr(BitArray256 other) { return this | other; }

        /// <inheritdoc />
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly BitArray256 BitNot() { return ~this; }

        /// <inheritdoc />
        public readonly int CountBits() {
            return math.countbits(this.data1) + math.countbits(this.data2) + math.countbits(this.data3) +
                   math.countbits(this.data4);
        }
        ...
        public readonly bool Equals(BitArray256 other) {
            return this.data1 == other.data1 && this.data2 == other.data2 && this.data3 == other.data3 &&
    ...
    public static class BitArrayUtilities {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Get8(uint index, byte data) { return (data & (1u << (int)index)) != 0u; }
        ...
        /// <returns> The value of the bit at the specific index. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Get16(uint index, ushort data) { return (data & (1u << (int)index)) != 0u; }
        ...
        /// <returns> The value of the bit at the specific index. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Get32(uint index, uint data) { return (data & (1u << (int)index)) != 0u; }
        ...
        /// <returns> The value of the bit at the specific index. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Get64(uint index, ulong data) { return (data & (1uL << (int)index)) != 0uL; }
        ...
        /// <returns> The value of the bit at the specific index. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Get128(uint index, ulong data1, ulong data2) { return Get128((int)index, data1, data2); }
        ...
        /// <param name="value"> Value to set the bit to. </param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Set256(uint index,
            ref ulong data1,
            ref ulong data2,
            ref ulong data3,
            ref ulong data4,
