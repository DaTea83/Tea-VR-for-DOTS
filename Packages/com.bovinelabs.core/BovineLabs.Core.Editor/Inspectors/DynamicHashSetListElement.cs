...
namespace BovineLabs.Core.Editor.Inspectors {
    ...
    public class
        DynamicHashSetListElement<TBuffer, T> : DynamicListElement<TBuffer, DynamicHashSetListElement<TBuffer, T>.KVP>
        ...
        private DynamicHashSet<T> GetSet => this.Context.EntityManager.GetBuffer<TBuffer>(this.Context.Entity, true)
            .AsHashSet<TBuffer, T>();
