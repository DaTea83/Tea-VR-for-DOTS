        ...
        public unsafe struct UpdateTimeJob : IJobChunk {
            ...
            public void Execute(in ArchetypeChunk chunk,
                ...
                if (activeChanged || chunk.DidChange(ref this.RemainingHandle, this.SystemVersion)) {
                    ...
                    CalculateOnVectorized(remainings, this.onBuffer.GetUnsafeReadOnlyPtr(), this.onBuffer.Length,
                        this.DeltaTime);
                    ...
                    var hasChanged = UnsafeUtility.MemCmp(original, updated,
                        UnsafeUtility.SizeOf<bool>() * this.onBuffer.Length) != 0;
            ...
            private static void CalculateOnVectorized([NoAlias] float* remainings,
                [NoAlias] bool* isOn,
                int length,
                float deltaTime) {
