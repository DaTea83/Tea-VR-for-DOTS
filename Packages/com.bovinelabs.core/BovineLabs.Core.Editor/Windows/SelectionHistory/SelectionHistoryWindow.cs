...
namespace BovineLabs.Core.Editor.Windows.SelectionHistory {
    ...
    /// </summary>
    public sealed class SelectionHistoryWindow : BaseObjectWindow<SelectionHistoryItem, SelectionHistoryService,
        SelectionHistoryPreferences> {
        ...
        protected override string StylesheetPath =>
            "Packages/com.bovinelabs.core/BovineLabs.Core.Editor/Windows/SelectionHistory/SelectionHistoryWindow.uss";
        ...
        protected override GUIContent WindowTitle =>
            new("Selection", EditorGUIUtility.IconContent("UnityEditor.ConsoleWindow").image);
        ...
        /// <inheritdoc/>
        protected override void OnListItemClicked(SelectionHistoryItem item) { this.historyService?.SelectItem(item); }
        ...
        private void OnLockedListClick(ClickEvent evt) {
            ...
            if (item != null) {
                ...
                if (Equals(this.lastLockedClickedItem, item) &&
                    timeSinceLastClick < this.Service.DoubleClickThreshold) {
        ...
        private void OnPinButtonClick(ClickEvent evt) { evt.StopPropagation(); }

        private void OnLockedItemReordered(int fromIndex, int toIndex) {
            this.historyService?.ReorderLockedItem(fromIndex, toIndex);
        }

        private void OnWindowResize(GeometryChangedEvent evt) { this.UpdateLockedSectionHeight(); }
    }
}