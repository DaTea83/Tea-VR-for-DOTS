...
namespace BovineLabs.Core.Editor {
    ...
    public static class EditorMenus {
        ...
        private static void DebugLevelVerboseBLMenu() { BLLogLevel = LogLevel.Verbose; }
        ...
        private static void DebugLevelDebugBLMenu() { BLLogLevel = LogLevel.Debug; }
        ...
        private static void InfoLevelInfoBLMenu() { BLLogLevel = LogLevel.Info; }
        ...
        private static void WarningLevelWarningBLMenu() { BLLogLevel = LogLevel.Warning; }
        ...
        private static void ErrorLevelErrorBLMenu() { BLLogLevel = LogLevel.Error; }
        ...
        private static void FatalLevelFatalBLMenu() { BLLogLevel = LogLevel.Fatal; }
        ...
        private static void DataModeHierarchyDisabledMenu() { DataModeHierarchySet(DataMode.Disabled); }

        [MenuItem(DataModeHierarchyAuthoring, priority = 2)]
        private static void DataModeHierarchyAuthoringMenu() { DataModeHierarchySet(DataMode.Authoring); }

        [MenuItem(DataModeHierarchyMixed, priority = 3)]
        private static void DataModeHierarchyMixedMenu() { DataModeHierarchySet(DataMode.Mixed); }

        [MenuItem(DataModeHierarchyRuntime, priority = 4)]
        private static void DataModeHierarchyRuntimeMenu() { DataModeHierarchySet(DataMode.Runtime); }
        ...
        private static void PrefabLoadingMenu() { LoadPrefabsAsEntities.Enabled = !LoadPrefabsAsEntities.Enabled; }
