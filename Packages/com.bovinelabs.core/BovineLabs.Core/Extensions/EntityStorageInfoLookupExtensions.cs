...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class EntityStorageInfoLookupExtensions {
        public static void GetNameUnsafe(this EntityStorageInfoLookup lookup,
            Entity entity,
        ...
        [SuppressMessage("StyleCop.CSharp.OrderingRules",
            "SA1214:Readonly fields should appear before non-readonly fields", Justification = "Memory")]
        private struct EntityStorageInfoLookupAccess {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            internal AtomicSafetyHandle Safety;
#endif
            [NativeDisableUnsafePtrRestriction] internal readonly EntityDataAccess* EntityDataAccess;
        }
    }
}