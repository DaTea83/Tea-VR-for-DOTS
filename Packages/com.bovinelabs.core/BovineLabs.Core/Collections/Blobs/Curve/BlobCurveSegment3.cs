...
namespace BovineLabs.Core.Collections {
    ...
    public struct BlobCurveSegment3 {
        ...
        public float3 Sample(float4 timeSerial) { return math.mul(timeSerial, this.Factors); }
        ...
        /// </summary>
        public static BlobCurveSegment3 Unity3(float3 value0,
            float3 tangent0,
            float3 tangent1,
            float3 value1,
            float duration) {
        ...
        public static BlobCurveSegment3 Bezier3(float3 value0, float3 cv0, float3 cv1, float3 value1) {
            return new BlobCurveSegment3(BlobShared.BezierFactor(value0.x, cv0.x, cv1.x, value1.x),
        ...
        public static BlobCurveSegment3 Linear3(float3 value0, float3 value1) {
            return new BlobCurveSegment3(BlobShared.LinearFactor(value0.x, value1.x),
