...
namespace BovineLabs.Core.Tests.Iterators.Columns {
    ...
    public class OrderedListColumnTests : ECSTestsFixture {
        ...
        public void WithOrderedColumn_RemovalShouldMaintainSortedOrder() {
            ...
            CollectionAssert.AreEqual(expectedOrder, columnValues,
                "Column values should remain in sorted order after removal");
            ...
            CollectionAssert.AreEqual(expectedOrder, columnValues,
                "Column values should remain sorted after removing minimum");
        }
        ...
        public void OrderedColumn_GetFirstAndGetNext_ShouldMatchIteratorPattern() {
            ...
            CollectionAssert.AreEqual(simpleIndices, iteratorIndices,
                "Both iteration methods should return same indices");
        }
        ...
        public void Replace_WithMultipleSameValues_ShouldMaintainCorrectOrder() {
            ...
            CollectionAssert.AreEqual(expectedOrder, columnValues,
                "Should maintain correct order after replacing duplicate");
        }
        ...
        public void Replace_AfterResize_ShouldMaintainSortOrder() {
            ...
            CollectionAssert.AreEqual(expectedOrder, columnValues,
                "Should maintain sorted order after resize and replace");
        }
        ...
        private struct TestOrderedMap : IDynamicVariableMap<int, float, int, OrderedListColumn<int>> {
            [UsedImplicitly] byte IDynamicVariableMap<int, float, int, OrderedListColumn<int>>.Value { get; }
        }
    }
}