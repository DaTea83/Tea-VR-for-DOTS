        ...
        public void OnUpdate(ref SystemState state) {
            ...
            foreach (var (transformData, lt, entity)
                ...
                if (transformData.ValueRO.CurrentTime < transformData.ValueRO.TotalTime) {
                    ...
                    lt.ValueRW.Position = math.lerp(lt.ValueRO.Position, transformData.ValueRO.Position,
                        transformData.ValueRO.CurrentTime / transformData.ValueRO.TotalTime);
                    lt.ValueRW.Rotation = math.slerp(lt.ValueRO.Rotation,
                        quaternion.Euler(transformData.ValueRO.Rotation),
                        transformData.ValueRO.CurrentTime / transformData.ValueRO.TotalTime);
                    lt.ValueRW.Scale = math.lerp(lt.ValueRO.Scale, transformData.ValueRO.Scale,
                        transformData.ValueRO.CurrentTime / transformData.ValueRO.TotalTime);
                }
                else
