...
namespace BovineLabs.Core.EntityCommands {
    ...
    public struct CommandBufferCommands : IEntityCommands {
        ...
        public CommandBufferCommands(EntityCommandBuffer commandBuffer,
        ...
        public void SetName(FixedString64Bytes name) { this.commandBuffer.SetName(this.Entity, name); }

        public void SetName(Entity entity, FixedString64Bytes name) { this.commandBuffer.SetName(entity, name); }
        ...
        public void AddComponent(in ComponentTypeSet components) { this.AddComponent(this.Entity, components); }
