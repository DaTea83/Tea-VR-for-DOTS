...
namespace BovineLabs.Core.Extensions {
    ...
    public static class MathematicsExtensions {
        ...
        public static float3 Right(this float4x4 value) { return new float3(value.c0.x, value.c0.y, value.c0.z); }

        /// <summary> Get the up vector from a transformation matrix. </summary>
        /// <param name="value"> The transformation matrix. </param>
        /// <returns> The up vector. </returns>
        public static float3 Up(this float4x4 value) { return new float3(value.c1.x, value.c1.y, value.c1.z); }

        /// <summary> Get the forward vector from a transformation matrix. </summary>
        /// <param name="value"> The transformation matrix. </param>
        /// <returns> The forward vector. </returns>
        public static float3 Forward(this float4x4 value) { return new float3(value.c2.x, value.c2.y, value.c2.z); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 Right(this quaternion value) { return math.mul(value, math.right()); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 Up(this quaternion value) { return math.mul(value, math.up()); }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3 Forward(this quaternion value) { return math.mul(value, math.forward()); }

        /// <summary> Get the position from a transformation matrix. </summary>
        /// <param name="value"> The transformation matrix. </param>
        /// <returns> The position. </returns>
        public static float3 Position(this float4x4 value) { return new float3(value.c3.x, value.c3.y, value.c3.z); }

        /// <summary> Get the rotation from a transformation matrix. </summary>
        /// <param name="value"> The transformation matrix. </param>
        /// <returns> The rotation. </returns>
        public static quaternion Rotation(this float4x4 value) { return new quaternion(value); }
    }
}