...
namespace BovineLabs.Core.Internal {
    ...
    public static class CollectionInternal {
        // NativeHashMap
        public static UnsafeParallelHashMap<TKey, TValue> GetUnsafeHashMap<TKey, TValue>(
        ...
        public static UnsafeParallelHashMap<TKey, TValue> GetReadOnlyUnsafeHashMap<TKey, TValue>(
            this NativeParallelHashMap<TKey, TValue> hashMap)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
        public static void SetSafety<TKey, TValue>(this ref NativeParallelHashMap<TKey, TValue> hashMap,
        ...
        public static NativeParallelHashMap<TKey, TValue> AsNative<TKey, TValue>(
            this UnsafeParallelHashMap<TKey, TValue> hashMapData)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        public static UnsafeParallelMultiHashMap<TKey, TValue> GetUnsafeMultiHashMap<TKey, TValue>(
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
        public static void SetSafety<TKey, TValue>(this ref NativeParallelMultiHashMap<TKey, TValue> hashMap,
            AtomicSafetyHandle safetyHandle)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
            hashMap.m_Safety = safetyHandle;
        ...
        internal static unsafe HashMapHelper<TKey>* GetReadOnlyHashMapHelper<TKey, TValue>(
        ...
        public static NativeParallelMultiHashMap<TKey, TValue> AsNative<TKey, TValue>(
