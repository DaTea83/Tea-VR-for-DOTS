...
namespace BovineLabs.Core.Jobs {
    ...
    public static class JobParallelHashMapDefer {
        public static unsafe JobHandle ScheduleParallel<TJob, TKey, TValue>(
            ...
            return ScheduleParallelInternal(jobData, hashMap.m_MultiHashMapData.m_Buffer, atomicSafetyHandlePtr,
        ...
        public static unsafe JobHandle ScheduleParallel<TJob, TKey, TValue>(
            ...
            // validation in Big Unity.
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            var safety = UnsafeUtility
                .As<NativeParallelMultiHashMap<TKey, TValue>.ReadOnly,
                    NativeParallelMultiHashMapReadOnly<TKey, TValue>>(ref hashMap)
                .Safety;
        ...
        public static unsafe JobHandle ScheduleParallel<TJob, TKey, TValue>(
            ...
            return ScheduleParallelInternal(jobData, hashMap.m_HashMapData.m_Buffer, atomicSafetyHandlePtr,
                minIndicesPerJobCount, dependsOn);
        }
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            var safety = UnsafeUtility
                .As<NativeParallelHashMap<TKey, TValue>.ReadOnly, NativeParallelHashMapReadOnly<TKey, TValue>>(
                    ref hashMap).Safety;
            var atomicSafetyHandlePtr = UnsafeUtility.AddressOf(ref safety);
#else
            void* atomicSafetyHandlePtr = null;
        ...
        internal unsafe struct JobParallelHashMapVisitKeyValueProducer<T>
            ...
            internal static readonly SharedStatic<IntPtr> ReflectionData =
                SharedStatic<IntPtr>.GetOrCreate<JobParallelHashMapVisitKeyValueProducer<T>>();
