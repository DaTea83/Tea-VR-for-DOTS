...
namespace BovineLabs.Core.Spatial {
    ...
    public struct SpatialKeyedMap<T> : IDisposable
        ...
        public void Dispose(JobHandle dependency) { this.map.Dispose(dependency); }

        public JobHandle Build(NativeList<T> positions,
            JobHandle dependency,
            ResizeNativeKeyedMapJob resizeStub = default,
        ...
        public JobHandle Build(NativeArray<T> positions,
            JobHandle dependency,
            ResizeNativeKeyedMapJob resizeStub = default,
            QuantizeJob quantizeStub = default) {
        ...
        public struct ResizeNativeKeyedMapJob : IJob {
            ...
            [ReadOnly] public NativeArray<T> Length;
        ...
        public unsafe struct QuantizeJob : IJobFor {
            ...
            [NativeDisableParallelForRestriction] public NativeKeyedMap<int> Map;
    ...
    public static class SpatialKeyedMap {
        ...
        public readonly struct ReadOnly {
            ...
            [field: ReadOnly] public NativeKeyedMap<int> Map { get; }
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public int Hash(int2 quantized) { return SpatialKeyedMap.Hash(quantized, this.quantizeWidth); }
        }
        ...
        internal struct CalculateMap : IJob {
            ...
            public void Execute() { this.SpatialHashMap.RecalculateBuckets(); }
        }
    }
}