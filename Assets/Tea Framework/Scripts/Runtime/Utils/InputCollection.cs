...
namespace TeaFramework {
    public static partial class HelperCollection {
        internal static void GetInputType(EJoystickValue joystick,
            RefRO<LHandInputIData> lInput,
            RefRO<RHandInputIData> rInput,
            out float value) {
        ...
        internal static float GetInputType(this EJoystickValue joystick,
            RefRO<LHandInputIData> lInput,
            RefRO<RHandInputIData> rInput) {
        ...
        internal static void GetInputType(EDeviceType inputType,
            RefRO<LHandInputIData> lInput,
            RefRO<RHandInputIData> rInput,
            RefRO<HeadInputIData> hInput,
            out float2 value) {
        ...
        internal static float2 GetInputType(this EDeviceType inputType,
            RefRO<LHandInputIData> lInput,
            RefRO<RHandInputIData> rInput,
            RefRO<HeadInputIData> hInput) {
        ...
        public static float GetButtonValues(this EButtonType buttonType,
            RefRO<LHandInputIData> lInput,
            RefRO<RHandInputIData> rInput) {
