...
namespace BovineLabs.Core.Editor.ConfigVars {
    ...
    internal class ConfigVarStringBinding<TS> : IConfigVarBinding<string>
        ...
        public ConfigVarStringBinding(BaseField<string> baseField,
            ConfigVarAttribute attribute,
            SharedStatic<TS> sharedStatic) {
        ...
        public string Value {
            get => this.container
                .StringValue; // EditorPrefs.GetString(this.attribute.Name, this.attribute.DefaultValue);
        ...
        private void GainFocus(FocusInEvent focus) { this.hasFocus = true; }

        private void LoseFocus(FocusOutEvent focus) { this.hasFocus = false; }
    }
}