...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class ArchetypeChunkExtensions {
        public static bool DidChange(this ArchetypeChunk chunk,
            TypeIndex typeIndex,
            ref short typeLookupCache,
            uint version) {
            ChunkDataUtility.GetIndexInTypeArray(chunk.m_EntityComponentStore->GetArchetype(chunk.m_Chunk), typeIndex,
                ref typeLookupCache);
        ...
        public static NativeArray<T>.ReadOnly GetNativeArrayReadOnly<T>(this ArchetypeChunk archetypeChunk,
            ...
            var ptr = ChunkDataUtility.GetOptionalComponentDataWithTypeRO(archetypeChunk.m_Chunk, archetype, 0,
            ...
            var result =
                NativeArrayUnsafeUtility.ConvertExistingDataToNativeArray<T>(ptr, archetypeChunk.Count, Allocator.None);
#if ENABLE_UNITY_COLLECTIONS_CHECKS
        ...
        public static BufferAccessor<T> GetBufferAccessorRO<T>(this ArchetypeChunk archetypeChunk,
            ...
            if (Hint.Unlikely(bufferTypeHandle.m_LookupCache.Archetype != archetype)) {
                bufferTypeHandle.m_LookupCache.Update(
                    archetypeChunk.m_EntityComponentStore->GetArchetype(archetypeChunk.m_Chunk), typeIndex);
            }

            var ptr = ChunkDataUtility.GetOptionalComponentDataWithTypeRO(archetypeChunk.m_Chunk, archetype, 0,
                typeIndex, ref bufferTypeHandle.m_LookupCache);
            if (Hint.Unlikely(ptr == null)) {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
                return new BufferAccessor<T>(null, 0, 0, true, bufferTypeHandle.m_Safety0, bufferTypeHandle.m_Safety1,
                    0);
#else
...
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            return new BufferAccessor<T>(ptr, length, stride, bufferTypeHandle.IsReadOnly, bufferTypeHandle.m_Safety0,
        ...
        public static DynamicBufferAccessor GetDynamicBufferAccessor(this ArchetypeChunk chunk,
            ...
            ChunkDataUtility.GetIndexInTypeArray(archetype, chunkBufferTypeHandle.m_TypeIndex,
            ...
            var ptr = chunkBufferTypeHandle.IsReadOnly
                ...
                : ChunkDataUtility.GetComponentDataRW(chunk.m_Chunk, archetype, 0, typeIndexInArchetype,
        ...
        public static void CopyEnableMaskFrom<TD, TS>(
            ...
            ref ComponentTypeHandle<TD> destination,
...
#endif
            var dst = ChunkDataUtility.GetEnabledRefRW(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    destination.m_LookupCache.IndexInArchetype,
                    destination.GlobalSystemVersion, out var dstPtrChunkDisabledCount)
                .Ptr;

            var src = ChunkDataUtility.GetEnabledRefRO(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                source.m_LookupCache.IndexInArchetype).Ptr;

            var chunks = archetype->Chunks;
            var memoryOrderIndexInArchetype =
                archetype->TypeIndexInArchetypeToMemoryOrderIndex[source.m_LookupCache.IndexInArchetype];
            var srcPtrChunkDisabledCount =
                chunks.GetPointerToChunkDisabledCountForType(memoryOrderIndexInArchetype,
                    archetypeChunk.m_Chunk.ListIndex);
        ...
        public static v128* GetEnabledBitsRO<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle)
            ...
            return (v128*)ChunkDataUtility
                .GetEnabledRefRO(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    typeHandle.m_LookupCache.IndexInArchetype)
                .Ptr;
        }

        public static v128* GetEnabledBitsRW<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle,
            ...
            return (v128*)ChunkDataUtility.GetEnabledRefRW(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    typeHandle.m_LookupCache.IndexInArchetype, typeHandle.GlobalSystemVersion,
                    out ptrChunkDisabledCount)
                .Ptr;
        }

        public static ref readonly v128 GetRequiredEnabledBitsRO<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData, IEnableableComponent {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckReadAndThrow(typeHandle.m_Safety);
            ...
            var ptr = ChunkDataUtility.GetEnabledRefRO(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    typeHandle.m_LookupCache.IndexInArchetype)
                .Ptr;
        ...
        public static ref v128 GetRequiredEnabledBitsRW<T>(
            this in ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle,
            out int* ptrChunkDisabledCount)
            where T : unmanaged, IComponentData, IEnableableComponent {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            ...
            var ptr = ChunkDataUtility.GetEnabledRefRW(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    typeHandle.m_LookupCache.IndexInArchetype,
        ...
        public static void UpdateChunkDisabledCount(this in ArchetypeChunk archetypeChunk,
        ...
        public static void GetEnableableActiveMasks(this ArchetypeChunk archetypeChunk,
            out ulong mask0,
            out ulong mask1) {
        ...
        public static EnabledMask GetEnabledMaskNoCheck<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckReadAndThrow(typeHandle.m_Safety);
            ...
            var ptr = typeHandle.IsReadOnly
                ? ChunkDataUtility.GetEnabledRefRO(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    typeHandle.m_LookupCache.IndexInArchetype).Ptr
                : ChunkDataUtility.GetEnabledRefRW(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                        typeHandle.m_LookupCache.IndexInArchetype,
                        typeHandle.GlobalSystemVersion, out ptrChunkDisabledCount)
                    .Ptr;
#if ENABLE_UNITY_COLLECTIONS_CHECKS
        ...
        /// <param name="typeHandle"> Type handle for the component type <typeparamref name="T" />. </param>
        /// <returns> An <see cref="EnabledMask" /> instance for component <typeparamref name="T" /> in this chunk. </returns>
        public static EnabledMask GetEnabledMaskRO<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData, IEnableableComponent {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckReadAndThrow(typeHandle.m_Safety);
            ...
            var ptr = GetEnabledRefRWNoChange(archetypeChunk.m_Chunk, archetypeChunk.Archetype.Archetype,
                    typeHandle.m_LookupCache.IndexInArchetype,
        ...
        public static ref T GetChunkComponentDataRW<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckWriteAndThrow(typeHandle.m_Safety);
            ...
            var ptr = archetypeChunk.m_EntityComponentStore->GetComponentDataWithTypeRW(metaChunkEntity,
                typeHandle.m_TypeIndex,
        ...
        public static T* GetChunkComponentDataPtrRW<T>(this ArchetypeChunk archetypeChunk,
            ref ComponentTypeHandle<T> typeHandle)
            where T : unmanaged, IComponentData {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckWriteAndThrow(typeHandle.m_Safety);
        ...
        public static DynamicBuffer<T> GetChunkBuffer<T>(this ArchetypeChunk chunk,
            ref BufferTypeHandle<T> bufferTypeHandle)
            where T : unmanaged, IBufferElementData {
#if ENABLE_UNITY_COLLECTIONS_CHECKS
            AtomicSafetyHandle.CheckReadAndThrow(bufferTypeHandle.m_Safety0);
            ...
            if (bufferTypeHandle.IsReadOnly) {
                header = (BufferHeader*)chunk.m_EntityComponentStore->GetComponentDataWithTypeRO(metaChunkEntity,
                    bufferTypeHandle.m_TypeIndex);
            }
            else {
                header = (BufferHeader*)chunk.m_EntityComponentStore->GetComponentDataWithTypeRW(metaChunkEntity,
                    bufferTypeHandle.m_TypeIndex,
            ...
            return new DynamicBuffer<T>(header, bufferTypeHandle.m_Safety0, bufferTypeHandle.m_Safety1,
                bufferTypeHandle.IsReadOnly, useMemoryInit,
        ...
        public static BitArray128 GetAny(this ArchetypeChunk archetypeChunk, NativeArray<ComponentType> components) {
            ...
            foreach (var componentType in components) {
                ref readonly var bits =
                    ref UnsafeEntityDataAccess.GetRequiredEnabledBitsRO(archetypeChunk, componentType);
        ...
        private static UnsafeBitArray GetEnabledRefRWNoChange(ChunkIndex chunk,
            Archetype* archetype,
            ...
            ptrChunkDisabledCount =
                chunks.GetPointerToChunkDisabledCountForType(memoryOrderIndexInArchetype, chunkListIndex);
        ...
        public static void JournalAddRecord(
            ...
            fixed (ArchetypeChunk* archetypeChunk = &chunk) {
                EntitiesJournaling.AddRecord(recordType, archetypeChunk->m_EntityComponentStore, globalSystemVersion,
                    archetypeChunk, 1, types: &typeIndex,
        ...
        private static void CheckZeroSizedComponentData<T>(in ComponentTypeHandle<T> chunkComponentType) {
            if (chunkComponentType.IsZeroSized) {
                throw new ArgumentException(
                    $"ArchetypeChunk.GetNativeArray<{typeof(T)}> cannot be called on zero-sized IComponentData");
            }
        }
    }
}