...
namespace BovineLabs.Core.Collections {
    ...
    public struct BlobCurveSampler2 : IBlobCurveSampler<float2> {
        ...
        public float2 Evaluate(in float time) { return this.Curve.Value.Evaluate(time, ref this.cache); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float2 EvaluateWithoutCache(in float time) { return this.Curve.Value.Evaluate(time); }
