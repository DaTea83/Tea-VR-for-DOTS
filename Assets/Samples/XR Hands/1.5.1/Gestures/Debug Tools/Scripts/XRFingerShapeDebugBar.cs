...
namespace UnityEngine.XR.Hands.Samples.Gestures.DebugTools {
    ...
    public class XRFingerShapeDebugBar : MonoBehaviour {
        ...
        [SerializeField] [Tooltip("The bar that displays the value by being scaled in its local x axis from 0 to 1.")]
        Transform m_ValueBar;

        [SerializeField]
        [Tooltip(
            "The target indicator that displays the target value by being positioned in its anchored x position from 0 to the bar container width.")]
        RectTransform m_TargetIndicator;

        [SerializeField]
        [Tooltip(
            "The range indicator that displays the upper range by being positioned in its anchored x position from the range center and with the width of the range, proportional to the bar container.")]
        RectTransform m_UpperRangeIndicator;

        [SerializeField]
        [Tooltip(
            "The range indicator that displays the lower range by being positioned in its anchored x position from the range center and with the width of the range, proportional to the bar container.")]
        RectTransform m_LowerRangeIndicator;

        [SerializeField] [Tooltip("The Image component that displays the upper range")]
        Image m_UpperRangeImage;

        [SerializeField] [Tooltip("The Image component that displays the lower range")]
        Image m_LowerRangeImage;

        [SerializeField] TextMeshProUGUI m_RangeStatusText;

        [SerializeField]
        [Tooltip(
            "The Image component that displays the cross icon, denoting that input is within range for a detected gesture")]
        Image m_CheckmarkImage;

        [SerializeField]
        [Tooltip(
            "The Image component that displays the cross icon, denoting that input is out of range for a detected gesture")]
        Image m_CrossImage;
        ...
        /// The container that determines the width of the max length bar, and holds the target and range indicators.
        /// </summary>
        public RectTransform barContainer { get => m_BarContainer; set => m_BarContainer = value; }

        /// <summary>
        /// The bar that displays the value by being scaled in its local x axis from <c>0</c> to <c>1</c>.
        /// </summary>
        public Transform valueBar { get => m_ValueBar; set => m_ValueBar = value; }
        ...
        /// </summary>
        public RectTransform targetIndicator { get => m_TargetIndicator; set => m_TargetIndicator = value; }
        ...
        /// </summary>
        public RectTransform upperRangeIndicator { get => m_UpperRangeIndicator; set => m_UpperRangeIndicator = value; }

        /// <summary>
        /// The <see cref="RectTransform"/> that displays the lower range by being positioned in its anchored x position from
        /// the range center and with the width of the range, proportional to the <see cref="barContainer"/>.
        /// </summary>
        public RectTransform lowerRangeIndicator { get => m_LowerRangeIndicator; set => m_LowerRangeIndicator = value; }

        /// <summary>
        /// The Image component that displays the upper range
        /// </summary>
        public Image upperRangeImage { get => m_UpperRangeImage; set => m_UpperRangeImage = value; }

        /// <summary>
        /// The Image component that displays the lower range
        /// </summary>
        public Image lowerRangeImage { get => m_LowerRangeImage; set => m_LowerRangeImage = value; }

        /// <summary>
        /// The text component that displays the status of a tracked fingerstate being within a target range
        /// </summary>
        public TextMeshProUGUI rangeStatusText { get => m_RangeStatusText; set => m_RangeStatusText = value; }

        /// <summary>
        /// The Image component that displays the checkmark image when within the valid range
        /// </summary>
        public Image checkmarkImage { get => m_CheckmarkImage; set => m_CheckmarkImage = value; }

        /// <summary>
        /// The Image component that displays the cross-image when outside of the valid range
        /// </summary>
        public Image crossImage { get => m_CrossImage; set => m_CrossImage = value; }
        ...
        void Awake() {
            ...
            m_RangeDeactivatedColor =
                new Color(m_RangeActiveColor.r, m_RangeActiveColor.g, m_RangeActiveColor.b, 0.35f);
