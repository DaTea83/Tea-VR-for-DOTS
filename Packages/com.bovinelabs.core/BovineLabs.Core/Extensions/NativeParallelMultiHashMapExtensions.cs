...
namespace BovineLabs.Core.Extensions {
    ...
    public static unsafe class NativeParallelMultiHashMapExtensions {
        public static void GetUniqueKeyArray<TKey, TValue>(this NativeParallelMultiHashMap<TKey, TValue> container,
        ...
        public static void GetUniqueKeyArray<TKey, TValue>(
            this NativeParallelMultiHashMap<TKey, TValue>.ReadOnly container,
            NativeList<TKey> keys)
            where TKey : unmanaged, IEquatable<TKey>, IComparable<TKey>
            where TValue : unmanaged {
            // Count provides read safety
        ...
        public static int Reserve<TKey, TValue>(
        ...
        public static void ClearLengthBuckets<TKey, TValue>(
        ...
        public static void ClearAndAddBatch<TKey, TValue>(
            ...
            UnsafeUtility.MemCpy(data.values, values.GetUnsafeReadOnlyPtr(),
        ...
        public static void ClearAndAddBatch<TKey, TValue>(
            ...
            UnsafeUtility.MemCpyStride(data.keys, UnsafeUtility.SizeOf<TKey>(), keys.GetUnsafeReadOnlyPtr(),
                keys.Stride, UnsafeUtility.SizeOf<TKey>(),
                keys.Length);

            UnsafeUtility.MemCpyStride(data.values, UnsafeUtility.SizeOf<TValue>(), values.GetUnsafeReadOnlyPtr(),
                values.Stride,
        ...
        public static void AddBatchUnsafe<TKey, TValue>(
            ...
            where TValue : unmanaged {
            CheckLengthsMatch(keys.Length, values.Length);
            AddBatchUnsafe(hashMap, (TKey*)keys.GetUnsafeReadOnlyPtr(), (TValue*)values.GetUnsafeReadOnlyPtr(),
                keys.Length);
        }
        ...
        /// <typeparam name="TKey"> The key type. </typeparam>
        /// <typeparam name="TValue"> The value type. </typeparam>
        public static void AddBatchUnsafe<TKey, TValue>([NoAlias] this NativeParallelMultiHashMap<TKey, TValue> hashMap,
        ...
        public static void Add<TKey, TValue>([NoAlias] this NativeParallelMultiHashMap<TKey, TValue> hashMap,
            TKey key,
            TValue item,
            int hash)
            where TKey : unmanaged, IEquatable<TKey>
        ...
        public static void SetAllocatedIndexLength<TKey, TValue>(
            [NoAlias] this NativeParallelMultiHashMap<TKey, TValue> hashMap,
            int length)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        private static void GetUniqueArray<TKey, TValue>(UnsafeParallelMultiHashMap<TKey, TValue> container,
            NativeList<TKey> keys)
            where TKey : unmanaged, IEquatable<TKey>, IComparable<TKey>
            where TValue : unmanaged {
