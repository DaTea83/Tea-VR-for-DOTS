...
namespace BovineLabs.Core.Collections {
    ...
    public struct BlobCurveSampler : IBlobCurveSampler<float> {
        ...
        public float Evaluate(in float time) { return this.Curve.Value.Evaluate(time, ref this.cache); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float EvaluateWithoutCache(in float time) { return this.Curve.Value.Evaluate(time); }
