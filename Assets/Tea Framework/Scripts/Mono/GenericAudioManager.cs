...
namespace TeaFramework
{
    ...
    {
        [SerializeField] protected AudioResourceSerialize<T>[] audioResource;
        ...
        public virtual void PlayClip(T id, byte audioPriority = (byte)EAudioPriority.Average) => PlayClipAtPos(id, float3.zero, audioPriority);
    ...
    [Serializable]
    public struct AudioResourceSerialize<T>
        where T : Enum
    {
        public T id;
