...
namespace BovineLabs.Core.Spatial {
    ...
    public struct SpatialMap3<T> : IDisposable
        ...
        public SpatialMap3.ReadOnly AsReadOnly() {
            return new SpatialMap3.ReadOnly(this.quantizeStep, this.quantizeSize, this.quantizeSize, this.halfSize,
                this.map);
        }
        ...
        public unsafe struct QuantizeJob : IJobFor {
            ...
            [NativeDisableParallelForRestriction] public NativeParallelMultiHashMap<long, int> Map;
    ...
    public static class SpatialMap3 {
        ...
        public readonly struct ReadOnly {
            ...
            public ReadOnly(float quantizeStep,
                int quantizeWidth,
                int quantizeDepth,
                int3 halfSize,
            ...
            [field: ReadOnly] public NativeParallelMultiHashMap<long, int> Map { get; }
