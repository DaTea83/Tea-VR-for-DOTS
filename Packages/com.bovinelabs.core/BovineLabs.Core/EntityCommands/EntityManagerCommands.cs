...
namespace BovineLabs.Core.EntityCommands {
    ...
    public struct EntityManagerCommands : IEntityCommands {
        ...
        public EntityManagerCommands(EntityManager entityManager,
        ...
        public void SetName(FixedString64Bytes name) { this.entityManager.SetName(this.Entity, name); }

        public void SetName(Entity entity, FixedString64Bytes name) { this.entityManager.SetName(entity, name); }
