...
namespace BovineLabs.Core.Extensions {
    ...
    public static class ComponentSystemBaseExtensions {
        public static unsafe SharedComponentDataFromIndex<T> GetSharedComponentDataFromIndex<T>(
        ...
        public static unsafe SharedComponentLookup<T> GetSharedComponentLookup<T>(this ComponentSystemBase system,
            bool isReadOnly = false)
