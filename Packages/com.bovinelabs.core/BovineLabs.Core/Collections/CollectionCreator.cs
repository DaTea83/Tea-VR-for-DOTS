...
namespace BovineLabs.Core.Collections {
    ...
    public static unsafe class CollectionCreator {
        public static UnsafeHashMap<TKey, TValue>* CreateHashMap<TKey, TValue>(int initialCapacity,
        ...
        public static UnsafeMultiHashMap<TKey, TValue>* CreateMultiHashMap<TKey, TValue>(int initialCapacity,
            AllocatorManager.AllocatorHandle allocator)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        public static UnsafeHashSet<T>* CreateHashSet<T>(int initialCapacity,
            AllocatorManager.AllocatorHandle allocator)
        ...
        public static UnsafeParallelHashMap<TKey, TValue>* CreateParallelHashMap<TKey, TValue>(int initialCapacity,
            AllocatorManager.AllocatorHandle allocator)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
