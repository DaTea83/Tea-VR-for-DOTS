...
namespace BovineLabs.Core.Editor.SearchWindow {
    ...
    internal class TreeNode<T> {
        ...
        public TreeNode<T>[] AddChildren(params T[] values) { return values.Select(this.AddChild).ToArray(); }

        public bool RemoveChild(TreeNode<T> node) { return this.children.Remove(node); }
