...
namespace BovineLabs.Core.Collections {
    ...
    public struct BlobCurveHeader {
        ...
        public unsafe int SearchIgnoreWrapMode(in float time,
            [NoAlias] ref BlobCurveCache cache,
            [NoAlias] out float t) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool Approximately(float value, float equals) { return math.abs(value - equals) < 1.1921e-07F; }
    }
}