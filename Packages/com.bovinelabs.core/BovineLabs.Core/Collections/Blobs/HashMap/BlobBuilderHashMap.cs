...
namespace BovineLabs.Core.Collections {
    ...
    public ref struct BlobBuilderHashMap<TKey, TValue>
        ...
        internal BlobBuilderHashMap(int capacity,
            ...
            this.data = new BlobBuilderHashMapData<TKey, TValue>(capacity, bucketCapacityRatio, ref blobBuilder,
                ref data);
        }
        ...
        public ref TValue AddUnique(TKey key) { return ref this.data.AddUnique(key, false); }

        public bool TryAdd(TKey key, TValue value) { return this.data.TryAdd(key, value, false); }

        public bool ContainsKey(TKey key) { return this.data.ContainsKey(key); }
    }
}