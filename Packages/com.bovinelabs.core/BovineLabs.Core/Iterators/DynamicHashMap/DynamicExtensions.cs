...
namespace BovineLabs.Core.Iterators {
    ...
    public static unsafe class DynamicExtensions {
        ...
        public static DynamicBuffer<TBuffer> InitializeHashMap<TBuffer, TKey, TValue>(
            ...
            int capacity = 0,
            int minGrowth = DefaultMinGrowth)
        ...
        public static DynamicBuffer<TBuffer> InitializePerfectHashMap<TBuffer, TKey, TValue>(
            this DynamicBuffer<TBuffer> buffer,
            DynamicHashMap<TKey, TValue> map,
            TValue nullValue)
            where TBuffer : unmanaged, IDynamicPerfectHashMap<TKey, TValue>
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DynamicMultiHashMap<TKey, TValue> AsMultiHashMap<TBuffer, TKey, TValue>(
            this DynamicBuffer<TBuffer> buffer)
            where TBuffer : unmanaged, IDynamicMultiHashMap<TKey, TValue>
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DynamicPerfectHashMap<TKey, TValue> AsPerfectHashMap<TBuffer, TKey, TValue>(
            this DynamicBuffer<TBuffer> buffer)
            where TBuffer : unmanaged, IDynamicPerfectHashMap<TKey, TValue>
            where TKey : unmanaged, IEquatable<TKey>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DynamicVariableMap<TKey, TValue, T, TC> AsVariableMap<TBuffer, TKey, TValue, T, TC>(
            this DynamicBuffer<TBuffer> buffer)
            where TBuffer : unmanaged, IDynamicVariableMap<TKey, TValue, T, TC>
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static DynamicVariableMap<TKey, TValue, T1, TC1, T2, TC2> AsVariableMap<TBuffer, TKey, TValue, T1, TC1,
            T2, TC2>(this DynamicBuffer<TBuffer> buffer)
            where TBuffer : unmanaged, IDynamicVariableMap<TKey, TValue, T1, TC1, T2, TC2>
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged
            where T1 : unmanaged, IEquatable<T1>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static DynamicPerfectHashMapHelper<TKey, TValue>* AsHelper<TKey, TValue>(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static DynamicVariableMapHelper<TKey, TValue, T, TC>* AsVariableHelper<TKey, TValue, T, TC>(
            this DynamicBuffer<byte> buffer)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged
            where T : unmanaged, IEquatable<T>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static DynamicVariableMapHelper<TKey, TValue, T1, TC1, T2, TC2>* AsVariableHelper<TKey, TValue, T1,
            TC1, T2, TC2>(this DynamicBuffer<byte> buffer)
            where TKey : unmanaged, IEquatable<TKey>
            where TValue : unmanaged
            where T1 : unmanaged, IEquatable<T1>
            where TC1 : unmanaged, IColumn<T1>
