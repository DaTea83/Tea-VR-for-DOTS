    ...
    public abstract class BitFieldAttributeEditor<T> : PropertyDrawer
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            ...
            if (attr.Flags) {
                ...
                string FormatCallback(int i) { return k.FirstOrDefault(key => i == key.Value).Name ?? "[None]"; }
            }
        }
        ...
        private static Dictionary<int, int> GetRemap(IEnumerable<(string Name, int Value)> data,
