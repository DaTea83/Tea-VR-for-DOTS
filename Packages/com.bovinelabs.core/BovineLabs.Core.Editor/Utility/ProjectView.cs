    ...
    public static class ProjectView {
        public static class Internal {
            ...
            static Internal() {
                ...
                GetActiveFolderPathFunc =
                    (Func<string>)Delegate.CreateDelegate(typeof(Func<string>), getActiveFolderPathMethod!);

                var getProjectBrowserIfExistsMethod = projectWindowUtilType.GetMethod("GetProjectBrowserIfExists",
                    BindingFlags.Static | BindingFlags.NonPublic);
                GetProjectBrowserIfExistsFunc =
                    (Func<object>)Delegate.CreateDelegate(typeof(Func<object>), getProjectBrowserIfExistsMethod!);

                ViewMode = getProjectBrowserIfExistsMethod!.ReturnType.GetField("m_ViewMode",
                ...
                ShowFolderContentsMethod = ProjectBrowserType.GetMethod("ShowFolderContents",
                    BindingFlags.Instance | BindingFlags.NonPublic)!;
                EndPingMethod =
                    ProjectBrowserType.GetMethod("EndPing", BindingFlags.Instance | BindingFlags.NonPublic)!;
            }
            ...
            public static void EndPing(object projectBrowser) { EndPingMethod.Invoke(projectBrowser, null); }
        }
    }
}