...
namespace BovineLabs.Core.Collections {
    ...
    public unsafe struct ThreadList {
        ...
        [NativeDisableUnsafePtrRestriction] private Lists* buffer;

        public ThreadList(AllocatorManager.AllocatorHandle allocator) {
            this.allocator = allocator;
            this.buffer = (Lists*)Memory.Unmanaged.Allocate(sizeof(Lists) * JobsUtility.ThreadIndexCount,
                UnsafeUtility.AlignOf<Lists>(), allocator);
        ...
        public ref UnsafeList<byte> GetList() { return ref this.GetList(JobsUtility.ThreadIndex); }
        ...
        private struct Lists {
            [FieldOffset(0)] public UnsafeList<byte> List;
        }
    }
}