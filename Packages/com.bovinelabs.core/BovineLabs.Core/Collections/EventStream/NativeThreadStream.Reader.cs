    ...
    public unsafe partial struct NativeThreadStream {
        ...
        public struct Reader : INativeStreamReader {
            ...
            internal Reader(ref NativeThreadStream stream) {
                ...
                CollectionHelper.SetStaticSafetyId(ref this.m_Safety, ref s_staticSafetyId.Data,
                    "BovineLabs.Core.Collections.NativeThreadStream.Reader");
#endif
            }
            ...
            public byte* ReadUnsafePtr(int size) {
                ...
                if (this.reader.m_CurrentPtr > this.reader.m_CurrentBlockEnd) {
                    ...
                    if (this.remainingBlocks <= 0) {
                        ...
                        this.reader.m_CurrentBlockEnd = (byte*)this.reader.m_CurrentBlock +
                                                        UnsafeThreadStreamBlockData.AllocationSize;
                    }
#else
                    this.reader.m_CurrentBlockEnd =
 (byte*)this.reader.m_CurrentBlock + UnsafeThreadStreamBlockData.AllocationSize;
#endif
