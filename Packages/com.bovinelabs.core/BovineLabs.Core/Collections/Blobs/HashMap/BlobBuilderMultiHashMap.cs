...
namespace BovineLabs.Core.Collections {
    ...
    public ref struct BlobBuilderMultiHashMap<TKey, TValue>
        ...
        internal BlobBuilderMultiHashMap(int capacity,
        ...
        public void Add(TKey key, TValue item) { this.data.TryAdd(key, item, true); }

        public ref TValue Add(TKey key) { return ref this.data.AddUnique(key, true); }
    }
}