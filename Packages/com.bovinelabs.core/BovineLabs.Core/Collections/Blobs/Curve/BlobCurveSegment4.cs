...
namespace BovineLabs.Core.Collections {
    ...
    public struct BlobCurveSegment4 {
        ...
        public float4 Sample(float4 timeSerial) { return math.mul(timeSerial, this.Factors); }
        ...
        public BlobCurveSegment4(Keyframe k0x,
            Keyframe k0y,
            Keyframe k0z,
            Keyframe k0w,
            Keyframe k1x,
        ...
        /// </summary>
        public static BlobCurveSegment4 Unity4(float4 value0,
            float4 tangent0,
            float4 tangent1,
            float4 value1,
            float duration) {
        ...
        public static BlobCurveSegment4 Bezier4(float4 value0, float4 cv0, float4 cv1, float4 value1) {
            return new BlobCurveSegment4(BlobShared.BezierFactor(value0.x, cv0.x, cv1.x, value1.x),
                BlobShared.BezierFactor(value0.y, cv0.y, cv1.y, value1.y),
                BlobShared.BezierFactor(value0.z, cv0.z, cv1.z, value1.z),
                BlobShared.BezierFactor(value0.w, cv0.w, cv1.w, value1.w));
        }
        ...
        public static BlobCurveSegment4 Linear4(float4 value0, float4 value1) {
            return new BlobCurveSegment4(BlobShared.LinearFactor(value0.x, value1.x),
